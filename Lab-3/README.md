...
### Step 5.  Fill in git repository details using the URL `https://github.com/jpatter/DSX-IBMCloud` and press `Create Project`.
...
### Step 7.  Click the `connection.R` file and fill in your DB2 Warehouse connection details.   You can find these from one of the previous labs.   Don't forget to set vetting.table to your prefix (if used) + 'FEMALE_HUMAN_TRAFFICKING'.   Save the file.
